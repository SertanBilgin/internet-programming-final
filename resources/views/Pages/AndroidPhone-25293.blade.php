@extends('Home')
@section('title', 'Andorid Telefonlar')
@section('AndroidPhone-25293')
		<!--start page wrapper -->
														...
														<div class="product-info">
															...
															<div class="product-action mt-2">
																<div class="d-grid gap-2">
																	<a href="{{ url('/Ürün_Hakkinda')}}" class="btn btn-light btn-ecomm">	<i class="bx bxs-cart-add"></i>Add to Cart</a>	<a href="javascript:;" class="btn btn-link btn-ecomm" data-bs-toggle="modal" data-bs-target="#QuickViewProduct"><i class="bx bx-zoom-in"></i>Quick View</a>
																</div>
															</div>
														</div>
													</div>
